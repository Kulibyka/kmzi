from simple_chiper import decode_substitution, encode_substitution, eng_alphabet, secret_key
...
while True:
    ...
    if not flag:
        ...
        if step == 25:
            break
print(try_key)
print(decode_substitution(chipher_text, ''.join(try_key)))
